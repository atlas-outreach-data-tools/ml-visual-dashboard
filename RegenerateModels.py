...
df_test00.to_csv('df_test.csv', index=True, index_label='index')
...
df_shortlist.to_csv('df_shortlist.csv', index=True, index_label='index')
df_shortlist_scaled.to_csv('df_shortlist_scaled.csv', index=True, index_label='index')
...
# # save from Jupyter
df_probs.to_csv('df_probs_2022.csv', index=True, index_label='index')
df_metrics.to_csv('df_metrics_2022.csv', index=True, index_label='index')
