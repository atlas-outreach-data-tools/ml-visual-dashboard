...
class DataBackend:
    def __init__(self):
        self.df_scatter = pd.read_csv('share/df_test.csv',index_col='index').drop_duplicates()
        self.df_shortlist = pd.read_csv('share/df_shortlist.csv',index_col='index').drop_duplicates()
        self.df_shortlist_scaled = pd.read_csv('share/df_shortlist_scaled.csv',index_col='index').drop_duplicates()
        self.df_probs = pd.read_csv('share/df_probs_2022.csv',index_col='index').drop_duplicates()
        self.df_metrics = pd.read_csv('share/df_metrics_2022.csv',index_col='index').drop_duplicates()
